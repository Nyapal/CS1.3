...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('hellooo', 'ooo') is True 
        assert contains('eatingyummytings', 'tings') is True
        assert contains('doyouspeakcode', 'eak') is True
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('hellothisisfun', 'really') is False 
        assert contains('example', 'test') is False 
        assert contains('writing', 'speaking') is False 
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('eatingfoodyummyeattings', 'tings') is True
        assert contains('doyouspeakcode', 'eak') is True
        assert contains('howmuchchuckwouldawouldchuckchuckchuckifawoodchuckcouldchuckchucks', 'chchuck') is True
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        assert find_index('hellooooo', 'ooo') == 4
        assert find_index('ahahaahahahaaaahaha', 'aaa') == 11
        assert find_index('lame', 'e') == 3
